Pod::Spec.new do |s|
  ...
  s.documentation_url = "https://github.com/yasuradodo/twitter-kit-ios/wiki"
  s.social_media_url = "https://taoren.me"
  s.authors = "Tao Ren"
  s.platform = :ios, "9.0"
  s.source = { :http => "https://github.com/yasuradodo/twitter-kit-ios/releases/download/v#{s.version}/TwitterKit.zip" }
